...
export const dictionaries = {
  ...
  promoted_rule_failed: 'Failed to promote rule: {error}',
      ...
      empty: {
        ...
        unknowns_all_categorized_title: 'All caught up',
        unknowns_all_categorized_note: 'Nothing uncategorized! Every transaction has a category.',
        unknowns_no_data_title: 'No transactions yet',
        unknowns_no_data_note: 'Upload a CSV or use sample data to get started.',
