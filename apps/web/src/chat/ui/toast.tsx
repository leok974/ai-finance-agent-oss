...
>(({ className, ...props }, ref) => (
  <Portal>
    <ToastPrimitives.Viewport
      ref={ref}
      data-sonner-toaster
      data-testid="chat-toast-viewport"
      className={cn(
...
// Chat-scoped version that listens to app:toast events (same as main app)
export function Toaster() {
  ...
  React.useEffect(() => {
    ...
    // Listen to app:toast events (same as main app, works in iframe context)
