/**
 * chat/ui-patched/dropdown-menu.tsx - Iframe-aware dropdown menu
 *
 * Wraps Radix DropdownMenu to use iframe-scoped portal.
 * Re-exports all primitives for drop-in compatibility.
 */
