...
def test_charts_endpoints_shapes_and_basic_values():
    ...
    # --- summary ---
    r1 = client.post(
        "/agent/tools/charts/summary", json={"month": month_b, "include_daily": True}
    )
    ...
    # --- merchants ---
    r2 = client.post(
        "/agent/tools/charts/merchants", json={"month": month_b, "top_n": 5}
    )
    ...
    r3 = client.post(
        ...
        json={"month": month_b, "top_merchants": 5, "top_categories": 5},
    )
    ...
    r4 = client.post(
        ...
        json={"months": [month_a, month_b], "order": "asc"},
    )
