def test_rules_save_normalizes_patterns_and_names_no_500(client):
    ...
    payload = {
        "rules": [
            {"id": "norm1", "name": "  Coffee  ", "pattern": " COFFEE | espresso ", "category": "restaurants", "enabled": True},
            {"id": "norm2", "name": "Transport-Uber", "pattern": " Uber  |  LYFT ", "category": "transport", "enabled": True},
        ]
    }
