...
class APIRouter:
    ...
    def _reg(self, method: str, path: str, **meta):
        def deco(fn: Callable):
            ...
            return fn
        return deco
    def get(self, path: str, **meta): return self._reg("GET", path, **meta)
    def post(self, path: str, **meta): return self._reg("POST", path, **meta)
    def put(self, path: str, **meta): return self._reg("PUT", path, **meta)
    def delete(self, path: str, **meta): return self._reg("DELETE", path, **meta)
...
__all__ = [
    'FastAPI','APIRouter','HTTPException','Depends','Query','Header','BackgroundTasks','Request'
]
